...
| 演出歌曲 | Bestdori 中国服可用目录，需提前收藏；同名歌曲区分乐队 |
...
1. 从主页进入演出。选歌前切到 Expert，避免残留的 Special 筛选隐藏没有该难度的歌曲。自由巡演为三个位置分别打开收藏，选择同一首歌和难度；每次选歌都验证选中项，开演前再次核对。同名歌曲还核对选歌页的演奏乐队，无法确认则不选择。
